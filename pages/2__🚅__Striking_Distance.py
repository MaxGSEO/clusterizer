...
# file uploader
uploaded_file = st.file_uploader("Upload your keyword file",
                                 help="""Upload a keyword report from ahrefs / semrush etc""")
...
if submitted:
    ...
    df_keywords.rename(
        columns={url_col: "Current URL", kw_col: "Keyword", vol_col: "Volume", pos_col: "Current position"},
        inplace=True)
